                ...
                return i(e, [{
                    ...
                    value: function() {
                        ...
                        if (this.paused && (this.paused = !1, this.template.button.classList.remove("aplayer-play"), this.template.button.classList.add("aplayer-pause"), this.template.button.innerHTML = "", setTimeout(function() {
                                ...
                                if (aplayerPic) {
                                    aplayerPic.style.animation = "rotate 5s infinite linear";
                                }
                    ...
                    value: function() {
                        var e = this;
                        this.paused || (this.paused = !0, this.template.button.classList.remove("aplayer-pause"), this.template.button.classList.add("aplayer-play"), document.querySelector(".aplayer-pic").style.animation = "none",  this.template.button.innerHTML = "", setTimeout(function() {
